...
import { usuariosApi } from '../services/endpoints.js';
...
export function AuthProvider({ children }) {
  ...
  if (supabaseConfigError) {
    return (
      <AuthContext.Provider
        value={{ session: null, perfil: null, cargando: false, iniciarSesion: async () => {}, cerrarSesion: async () => {}, recargarPerfil: async () => {} }}
      >
        {children}
      </AuthContext.Provider>
    );
  ...
  return (
    <AuthContext.Provider value={{ session, perfil, cargando, iniciarSesion, cerrarSesion, recargarPerfil: cargarPerfil }}>
      {children}
    </AuthContext.Provider>
  );
}
